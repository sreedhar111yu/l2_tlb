// =============================================================
// Read Request Generator (PTW)
// - Pipelined arbitration for 600 MHz
// - Ready/valid correct
// - Matches Excel request-side intent
// =============================================================
`timescale 1ns/1ps
module read_request_gen #(
  ...
  // =============================================================
  // Stage C: Drive PTW request + MSHR grant (READY/VALID CORRECT)
  // =============================================================
  logic ptw_fire;

  assign ptw_fire      = b_valid && ptw_req_ready;
  assign ptw_req_valid = ptw_fire;
  ...
  always_comb begin
    mshr_issue_grant = '0;
    if (ptw_fire)
      mshr_issue_grant[b_sel_idx] = 1'b1;
  end
