...
(
  ...
  // ======================================================
  logic csr_enable;
  logic csr_flush_all, csr_flush_asid_valid;
  logic [ASID_WIDTH-1:0] csr_asid, csr_flush_asid;
  logic core_hit, core_miss;

  l2_tlb_csr u_csr (
    .pclk_i, .presetn_i,
    .psel_i, .penable_i, .pwrite_i,
    .paddr_i, .pwdata_i,
    ...
    .hit_cnt_o(), .miss_cnt_o(), .err_cnt_o()
  );
  ...
  // ======================================================
  logic core_need_ptw;
  logic core_resp_valid, core_resp_error, core_resp_pgsize;
  ...
  logic                       plru_hit, plru_alloc;
  logic [$clog2(NUM_WAYS)-1:0] plru_hit_way, plru_victim;
  ...
  // ? FIX FOR LINE 194 (ARRAY, NOT SCALAR)
  logic [1:0] mshr_type [MSHR_DEPTH];
  assign mshr_type = '{default:'0};
  ...
  // MSHR
  // ======================================================
  logic mshr_rsp_valid, mshr_rsp_error;
  ...
  l2_tlb_response_fifo u_fifo (
    ...
    .l2_mshr_resp_id_i({3'b000, mshr_rsp_l1id}),
    .l2_mshr_resp_ppn_i(mshr_rsp_ppn),
    .l2_mshr_resp_perm_i('0),
    .l2_mshr_resp_page_size_i('0),
